export const INITIAL_QUIZZES = [
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "options": [
          {
            "text": "Asynchrony, Consistency, Isolation, Distribution",
            "isCorrect": false
          },
          {
          ...
          {
            "text": "Allocation, Concurrency, Indexing, Decoupling",
            "isCorrect": false
          },
          {
            "text": "Authenticity, Concurrency, Integrity, Durability",
            "isCorrect": false
          }
        ]
      },
      ...
      },
      {
        ...
        "options": [
          {
            "text": "Compiling frontend JavaScript source code into machine binaries",
            "isCorrect": false
          },
          {
            "text": "Creating database schemas and relational foreign keys automatically",
            "isCorrect": false
          },
          {
            "text": "Storing SSL private keys directly inside client web browsers",
            "isCorrect": false
          },
          {
            "text": "Intercepting and routing incoming client requests to backend servers",
            "isCorrect": true
          }
        ]
      },
