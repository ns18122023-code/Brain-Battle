...
import { Trophy, Award, Sparkles, Home, RotateCcw } from 'lucide-react';
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 min-h-[85vh] flex flex-col justify-between space-y-8">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-pink-400 to-purple-400">
          Final Winner Podium
        </h1>
      </div>
      ...
      <div className="flex items-end justify-center gap-3 sm:gap-6 min-h-[360px] pb-4">
        ...
        {secondPlace ? (
          <div className="flex flex-col items-center flex-1 max-w-[180px] animate-podium" style={{ animationDelay: '300ms' }}>
            ...
            <div className="w-full bg-gradient-to-t from-slate-700 to-slate-500 h-44 rounded-t-2xl border-t-4 border-slate-300 flex flex-col items-center justify-center p-2 shadow-2xl">
        ...
        {firstPlace ? (
          <div className="flex flex-col items-center flex-1 max-w-[200px] z-10 animate-podium" style={{ animationDelay: '0ms' }}>
            <div className="text-center mb-3">
              <span className="text-6xl block mb-1 drop-shadow-lg">👑 {firstPlace.avatar || '🚀'}</span>
              <h3 className="font-black text-amber-300 text-base sm:text-xl truncate max-w-[160px]">
                {firstPlace.nickname}
              </h3>
            ...
            <div className="w-full bg-gradient-to-t from-amber-600 via-amber-500 to-yellow-400 h-60 rounded-t-3xl border-t-4 border-yellow-200 flex flex-col items-center justify-center p-2 shadow-2xl shadow-amber-500/30">
        ...
        {thirdPlace ? (
          <div className="flex flex-col items-center flex-1 max-w-[180px] animate-podium" style={{ animationDelay: '600ms' }}>
            <div className="text-center mb-3">
            ...
            <div className="w-full bg-gradient-to-t from-amber-900 to-amber-700 h-36 rounded-t-2xl border-t-4 border-amber-500 flex flex-col items-center justify-center p-2 shadow-2xl">
      ...
      <div className="flex items-center justify-center gap-4 pt-4">
        <button
          ...
          className="flex items-center gap-2 px-6 py-3.5 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 text-white font-extrabold rounded-2xl shadow-xl transition-all cursor-pointer transform hover:scale-105 active:scale-95"
        >
